...
import { getYahooDailyActives, getYahooDailyLosers } from "../../services/stock"
...
const Header = () => {
    return (
        <>
            <h1 className=" font-bold text-2xl leading-5 text-white">Most Active Today</h1>
            <p className="my-3 text-sm">Discover the most traded equities in the trading day.</p>
...
const MostActives = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const data = await getYahooDailyActives(100)
                ...
                return (
                    <div className="w-full flex">
                        <div className="w-full lg:w-2/3 my-5 p-5 border-r border-r-neutral-700">
                            <h1 className=" font-bold text-2xl leading-5 text-white">Most Active Today data is currently not available.</h1>
                        </div>
                    </div>
                )
            }
